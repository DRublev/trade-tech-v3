...
func (c *authClient) SetToken(ctx context.Context, in *SetTokenRequest, opts ...grpc.CallOption) (*SetTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.Auth/SetToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) ClearToken(ctx context.Context, in *ClearTokenRequest, opts ...grpc.CallOption) (*ClearTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.Auth/ClearToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) HasToken(ctx context.Context, in *HasTokenRequest, opts ...grpc.CallOption) (*HasTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auth.Auth/HasToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Auth_ClearToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/ClearToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
