...
func (c *marketDataClient) GetCandles(ctx context.Context, in *GetCandlesRequest, opts ...grpc.CallOption) (*GetCandlesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/marketData.MarketData/GetCandles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *marketDataClient) SubscribeCandles(ctx context.Context, in *SubscribeCandlesRequest, opts ...grpc.CallOption) (MarketData_SubscribeCandlesClient, error) {
	stream, err := c.cc.NewStream(ctx, &MarketData_ServiceDesc.Streams[0], "/marketData.MarketData/SubscribeCandles", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *marketDataClient) SubscribeOrderbook(ctx context.Context, in *SubscribeOrderbookRequest, opts ...grpc.CallOption) (MarketData_SubscribeOrderbookClient, error) {
	stream, err := c.cc.NewStream(ctx, &MarketData_ServiceDesc.Streams[1], "/marketData.MarketData/SubscribeOrderbook", opts...)
	if err != nil {
		return nil, err
	}
...
func _MarketData_GetCandles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/marketData.MarketData/GetCandles",
	}
