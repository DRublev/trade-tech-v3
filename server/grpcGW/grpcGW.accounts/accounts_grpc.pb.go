...
func (c *accountsClient) GetAccounts(ctx context.Context, in *GetAccountsRequest, opts ...grpc.CallOption) (*GetAccountsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/accounts.Accounts/GetAccounts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *accountsClient) SetAccount(ctx context.Context, in *SetAccountRequest, opts ...grpc.CallOption) (*SetAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/accounts.Accounts/SetAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Accounts_SetAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/accounts.Accounts/SetAccount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
