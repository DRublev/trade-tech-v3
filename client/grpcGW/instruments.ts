...
export const GetInstrumentsRequest = {
  encode(_: GetInstrumentsRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },
  ...
  fromJSON(_: any): GetInstrumentsRequest {
    return {};
  },

  toJSON(_: GetInstrumentsRequest): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GetInstrumentsRequest>, I>>(_: I): GetInstrumentsRequest {
    const message = createBaseGetInstrumentsRequest();
    return message;
  },
};
...
export const SharesService = {
  getShares: {
    path: "/instruments.Shares/GetShares",
    requestStream: false,
...
export const SharesClient = makeGenericClientConstructor(SharesService, "instruments.Shares") as unknown as {
